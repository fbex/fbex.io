...
<header>
	<nav class="navbar bg-base-300 max-h-[88px]">
		<div class="max-w-4xl mx-auto w-[100%]">
			<div class="flex justify-between w-[100%] items-center">
				<div>
					<a href="/">
						<img src={logo} width="130" height="100" alt="fbex logo" />
					</a>
				</div>
				<div>
					<menu class="menu menu-horizontal px-1 items-center">
						<!--Desktop menu-->
						<li>
							<a href="/" class="hidden sm:flex" class:active={$page.url.pathname === '/'}>Home</a>
						</li>
						<li>
							<a
								href="/notes"
